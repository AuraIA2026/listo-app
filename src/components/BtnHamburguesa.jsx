...
const planes = [
  {
    id: 'basico', num: '1', emoji: '⚪', nombre: 'BÁSICO (Entrada)', contratos: '3 contratos',
    precio: 'RD$500', colorKey: 'standard', badge: 'INICIO',
    titulo: 'Plan Básico — Tu punto de partida',
  ...
  {
    id: 'gold', num: '2', emoji: '🟡', nombre: 'GOLD (Crecimiento)', contratos: '8 contratos',
    precio: 'RD$1,000', colorKey: 'gold', badge: 'POPULAR',
    titulo: 'Pack Gold — El más pedido',
    subtitulo: 'El favorito de los profesionales que quieren crecer.',
    descripcion: 'Aumenta tus oportunidades y presencia en búsquedas con 8 aplicaciones a trabajos.',
    beneficios: ['⚡ Mejor visibilidad que el Básico', '⚡ Hasta 8 postulaciones al mes', '⚡ Perfil Recomendado'],
    cta: '¡El plan para profesionales activos!',
  },
  {
    id: 'platinum', num: '3', emoji: '⚫', nombre: 'PLATINUM (Profesional)', contratos: '15 contratos',
    precio: 'RD$1,500', colorKey: 'platinum', badge: 'ACTIVO',
    titulo: 'Pack Platinum — Alto Nivel',
    ...
    beneficios: ['🔥 Mayor visibilidad en búsquedas', '🔥 Hasta 15 postulaciones al mes', '🔥 Badge destacado Platinum'],
    cta: 'Para quienes no quieren perderse grandes clientes.',
  },
  {
    id: 'vip', num: '4', emoji: '⭐', nombre: 'VIP (Élite Exclusivo)', contratos: '∞ contratos',
    precio: 'RD$2,500', colorKey: 'vip', badge: '💎VIP',
    titulo: 'VIP Élite — Solo Expertos',
    subtitulo: 'Sin límites. Requiere +3 años de experiencia.',
    descripcion: 'Postúlate ilimitadamente cada mes. Exclusividad total, contacto directo y estatus N°1.',
    beneficios: ['🚀 Postulaciones ILIMITADAS cada mes', '🚀 Máxima visibilidad N°1 garantizada', '🚀 Requiere +3 años exp. comprobada'],
