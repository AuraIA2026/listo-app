...
const txt = {
  es: {
    ...
    terms: [
      ...
      { title: '3. Pagos', body: 'Los pagos por los servicios deberán realizarse exclusivamente mediante los métodos habilitados por la plataforma.\n\na) Transferencias: El usuario podrá realizar pagos mediante transferencias bancarias directamente al profesional, según los datos proporcionados dentro de la aplicación.\n\nb) Pagos con tarjeta (dentro de la app): Cuando el usuario utilice tarjeta de crédito o débito, el pago será procesado a través de la plataforma. La plataforma actúa como facilitador del procesamiento del pago y podrá gestionar temporalmente los fondos antes de transferirlos al profesional.\n\nNo se permiten pagos en efectivo ni métodos fuera de los establecidos por la plataforma.' },
    ...
    termsUser: [
      ...
      { title: '3. Pagos', body: 'Los pagos podrán realizarse de las siguientes formas:\n\na) Pagos directos: El usuario puede pagar directamente al profesional mediante efectivo, transferencia u otros métodos acordados entre las partes. En estos casos, la plataforma no interviene en la transacción.\n\nb) Pagos con tarjeta (dentro de la app): Cuando el usuario elija pagar con tarjeta, el pago será procesado a través de la plataforma. La plataforma actúa únicamente como facilitador del procesamiento del pago, sin asumir responsabilidad sobre la ejecución del servicio.\n\nEl pago podrá ser retenido temporalmente y luego transferido al profesional según las condiciones internas de la plataforma.' },
      ...
      { title: '6. Cancelaciones', body: 'El usuario podrá cancelar un servicio.\n\nLas condiciones de cancelación podrán variar dependiendo del método de pago:\n- En pagos directos: se acuerdan con el profesional\n- En pagos con tarjeta: podrán aplicarse condiciones definidas dentro de la plataforma\n\nCancelaciones abusivas podrán generar restricciones.' },
      { title: '7. Conducta', body: 'El usuario se compromete a:\n- Tratar con respeto a los profesionales\n- No realizar actividades ilegales\n- No usar la plataforma de forma indebida\n\nEl incumplimiento podrá resultar en suspensión de la cuenta.' },
